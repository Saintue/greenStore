    ...
    <div className="flex justify-center">
      <div className="w-3/4 flex flex-col items-center min-h-screen bg-neutral-400 justify-between">
        ...
        <nav className="mb-5 mt-5 w-full justify-end flex">
            <NavLink to="/" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Main</NavLink>
            <NavLink to="/calculator" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full ml-3 mr-3">
              Calculator
            </NavLink>
        </nav>
      </div>
