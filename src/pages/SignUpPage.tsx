                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    maxLength={40}
                                    className="bg-gray-50 border-2 border-[#D3D1C1] text-gray-900 text-[28px] rounded-[25px] focus:ring-primary-600 focus:border-primary-600 block w-full h-[72px] p-2.5"
                                />
                            ...
                            <button
                                type="submit"
                                className="w-full border-2 border-[black] max-w-[300px] text-white bg-[#54755A] focus:ring-4 focus:outline-none font-balsamiq text-[30px] rounded-[30px] h-[60px] px-5 py-2.5 text-center"
                            >
                                Sign up
                            </button>
                            </div>
